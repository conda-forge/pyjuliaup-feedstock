...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyjuliaup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15628&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyjuliaup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyjuliaup` can be installed with:

```
conda install pyjuliaup
```

It is possible to list all of the versions of `pyjuliaup` available on your platform with:
